      ...
      <div className="w-full max-w-[100vw] sm:max-w-7xl mx-auto px-2.5 sm:px-4 md:px-6 lg:px-8 box-border laydesk2-audience-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center py-4 sm:py-0 sm:items-start laydesk2-audience-grid">
          ...
          <div className="flex flex-col justify-center items-center gap-1.5 sm:gap-1.5 lg:gap-2 laydesk2-audience-left-column">
            ...
            <div className="pl-2 pr-3 py-0.5 sm:pl-4 sm:pr-6 sm:py-2 bg-coffee-900/60 border border-coffee-700 rounded-2xl hover:border-coffee-500/50 transition-colors w-full max-w-md laydesk2-audience-card">
              <div className="flex items-center gap-2">
                <Shell className="w-6 h-6 text-coffee-500 flex-shrink-0 self-center" />
                <div className="pl-2">
                  <p className="text-xs sm:text-sm lg:text-base text-cream-50 leading-relaxed text-justify hyphens-none font-montserrat laydesk2-audience-card-text">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="pl-2">
                  <p className="text-xs sm:text-sm lg:text-base text-cream-50 leading-relaxed text-justify hyphens-none font-montserrat laydesk2-audience-card-text">
                    ...
                    <Link href="#contato" className="inline-block px-1.5 py-0.5 rounded-md bg-coffee-500/20 hover:bg-coffee-500/30 transition-colors laydesk2-audience-card-link">
